...
import data.permission_role_lookup as policies    
default allow = false      
...
allow {    
  ...
  every role in input.role{
    role in policies.readTaskService
}
}
...
#   input.resource ==["redfish","v1","AggregationService"] 
#   every role in input.role{
#     role in {"CreateJob","DeleteJob","ReadJob","OmcSystemAdministrator","OmcEquipmentAdministrator","OmcSecurityAdministrator","OmcSystemObserver","OmcEquipmentObserver"}
# }
# }
...
#   #allowed_HTTP_methods[input.method]
#   input.method == "GET"
#   input.resource == ["redfish","v1","TaskService"]  
...
# allow {    
#   input.method in ["GET"]# #/redfish/v1/TaskService/
# allow {
#   #allowed_HTTP_methods[input.method]
#   input.method == "GET"
#   input.resource == ["redfish","v1","TaskService"]  
...
#   #allowed_HTTP_methods[input.method]
#   input.method == "GET"
#   input.resource = ["redfish","v1","TaskService",id]  
#   every role in input.roles{
#     role in {"CreateJob","DeleteJob","OmcSystemAdministrator","OmcEquipmentAdministrator","OmcSecurityAdministrator"}
#   }
# } 
