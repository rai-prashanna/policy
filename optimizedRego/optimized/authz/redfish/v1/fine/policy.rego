...
allow = __result__ {
	...
	"POST" = input.method
	"OmcEquipmentAdministrator" = input.roles[__local7__1]
	__result__ = true
}
...
allow = __result__ {
	...
	"GET" = input.method
	"CreateJob" = input.roles[__local7__1]
	__result__ = true
}
...
allow = __result__ {
	glob.match("/AggregationService", ["/"], input.resource)
	"GET" = input.method
	"DeleteJob" = input.roles[__local7__1]
	__result__ = true
}
...
allow = __result__ {
	glob.match("/AggregationService", ["/"], input.resource)
	"GET" = input.method
	"OmcEquipmentObserver" = input.roles[__local7__1]
	__result__ = true
}
...
allow = __result__ {
	glob.match("/AggregationService", ["/"], input.resource)
	"GET" = input.method
	"OmcSecurityAdministrator" = input.roles[__local7__1]
	__result__ = true
}
...
allow = __result__ {
	glob.match("/AggregationService", ["/"], input.resource)
	"GET" = input.method
	"OmcSystemAdministrator" = input.roles[__local7__1]
	__result__ = true
}
...
allow = __result__ {
	glob.match("/AggregationService", ["/"], input.resource)
	"GET" = input.method
	"OmcSystemObserver" = input.roles[__local7__1]
	__result__ = true
}
...
allow = __result__ {
	glob.match("/AggregationService/AggregationSources/c/Oem/Ericsson_2/TrustedPublicKeys", ["/"], input.resource)
	"GET" = input.method
	"CreateJob" = input.roles[__local7__1]
	__result__ = true
}
