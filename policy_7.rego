...
allow {    
  #allowed_HTTP_methods[input.method]
  input.path = ["redfish","v1","AggregationService"]
  input.role =["CreateJob","DeleteJob","ReadJob","OmcSystemAdministrator","OmcEquipmentAdministrator","OmcSecurityAdministrator","OmcSystemObserver","OmcEquipmentObserver"]
  #allowed_roles[input.role]
}
...
allow {    
  ...
  input.path = ["redfish","v1","AggregationService","AggregationSources"]
...
allow {    
  ...
  input.path = ["redfish","v1","AggregationService","AggregationSources",aggregationSourceId]
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","AggregationService","AggregationSources",aggregationSourceId,"Oem","Ericsson_2","TrustedPublicKeys"]
  input.aggregationSourceId = aggregationSourceId
  input.role =["CreateJob","DeleteJob","ReadJob","OmcSystemAdministrator","OmcEquipmentAdministrator","OmcSecurityAdministrator","OmcSystemObserver","OmcEquipmentObserver"] 
  #allowed_roles[input.role]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","AggregationService","AggregationSources",aggregationSourceId,"Oem","Ericsson_2","TrustedPublicKeys",KeyId]
  input.KeyId = KeyId
  input.role =["CreateJob","DeleteJob","ReadJob","OmcSystemAdministrator","OmcEquipmentAdministrator","OmcSecurityAdministrator","OmcSystemObserver","OmcEquipmentObserver"] 
  #allowed_roles[input.role]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Chassis",ChassisId]
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Chassis",ChassisId,"Power"]
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Chassis",ChassisId,"Thermal"]
  input.ChassisId = ChassisId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","EventService"]
...
allow {    
  input.method in ["GET","POST"]
  input.path = ["redfish","v1","EventService","Subscriptions"]
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","EventService","Subscriptions",EventDestinationId]
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Managers"]
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Managers",ManagerId]
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Managers",ManagerId,"Certificates"]
  input.ManagerId=ManagerId
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Managers",ManagerId,"Certificates",CertificateId]
  input.ManagerId=ManagerId
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Managers",ManagerId,"LogServices"]
  input.ManagerId=ManagerId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Managers",ManagerId,"LogServices",LogServiceId]
...
allow {    
  input.method in ["POST"]
  input.path = ["redfish","v1","Managers",ManagerId,"LogServices",LogServiceId,"Actions","Oem","Ericsson2LogService.RetrieveLog"]
  input.LogServiceId=LogServiceId
  input.ManagerId=ManagerId
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Managers",ManagerId,"NetworkProtocol"]
  input.ManagerId=ManagerId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["POST"]
  input.path = ["redfish","v1","Managers",ManagerId,"Oem","Ericsson_2","RemoteBackupService","Actions","Ericsson2RemoteBackupService.CreateManagerBackup"]
  input.ManagerId=ManagerId
  input.role in ["OmcEquipmentAdministrator"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Managers",ManagerId,"Oem","Ericsson_2","RemoteBackupService","ManagerBackups"]
  input.ManagerId=ManagerId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Managers",ManagerId,"Oem","Ericsson_2","RemoteBackupService","ManagerBackups",ManagerBackupId]
  input.ManagerId=ManagerId
...
allow {    
  input.method in ["GET","DELETE"]
  input.path = ["redfish","v1","Managers",ManagerId,"Oem","Ericsson_2","RemoteUpdateService"]
  input.ManagerId=ManagerId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["POST"]
  input.path = ["redfish","v1","Managers",ManagerId,"Oem","Ericsson_2","RemoteUpdateService","Actions","Ericsson2RemoteUpdateService.CreateAssetUpgradeJob"]
  input.ManagerId=ManagerId
  input.role in ["OmcEquipmentAdministrator"]
}
...
allow {    
  input.method in ["POST"]
  input.path = ["redfish","v1","Managers",ManagerId,"Oem","Ericsson_2","RemoteUpdateService","Actions","Ericsson2RemoteUpdateService.RemoveSoftwareVersion"]
  input.ManagerId=ManagerId
  input.role in ["OmcEquipmentAdministrator"]
}
...
allow {    
  input.method in ["POST"]
  input.path = ["redfish","v1","Managers",ManagerId,"Oem","Ericsson_2","RemoteUpdateService","Actions","Ericsson2RemoteUpdateService.UpdateManager"]
  input.ManagerId=ManagerId
  input.role in ["OmcEquipmentAdministrator"]
}
...
allow {    
  input.method in ["POST"]
  input.path = ["redfish","v1","Managers",ManagerId,"Oem","Ericsson_2","RemoteUpdateService","Actions","Ericsson2RemoteUpdateService.UpdateManagerCancel"]
  input.ManagerId=ManagerId
  input.role in ["OmcEquipmentAdministrator"]
}
...
allow {    
  input.method in ["POST"]
  input.path = ["redfish","v1","Managers",ManagerId,"Oem","Ericsson_2","RemoteUpdateService","Actions","Ericsson2RemoteUpdateService.UploadSoftwarePackage"]
  input.ManagerId=ManagerId
  input.role in ["OmcEquipmentAdministrator"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Managers",ManagerId,"Oem","Ericsson_2","RemoteUpdateService","AssetUpgradeJobs"]
  input.ManagerId=ManagerId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Managers",ManagerId,"Oem","Ericsson_2","RemoteUpdateService","AssetUpgradeJobs",AssetUpgradeJobId]
  input.ManagerId=ManagerId
...
allow {    
  input.method in ["POST"]
  input.path = ["redfish","v1","Managers",ManagerId,"Oem","Ericsson_2","RemoteUpdateService","AssetUpgradeJobs",AssetUpgradeJobId,"Actions","Ericsson2AssetUpgradeJob.Abort"]
  input.ManagerId=ManagerId
  input.AssetUpgradeJobId=AssetUpgradeJobId
  input.role in ["OmcEquipmentAdministrator"]
}
...
allow {    
  input.method in ["POST"]
  input.path = ["redfish","v1","Managers",ManagerId,"Oem","Ericsson_2","RemoteUpdateService","AssetUpgradeJobs",AssetUpgradeJobId,"Actions","Ericsson2AssetUpgradeJob.Start"]
  input.ManagerId=ManagerId
  input.AssetUpgradeJobId=AssetUpgradeJobId
  input.role in ["OmcEquipmentAdministrator"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Managers",ManagerId,"Oem","Ericsson_2","RemoteUpdateService","Packages"]
  input.ManagerId=ManagerId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Managers",ManagerId,"Oem","Ericsson_2","TrustedCertificates"]
  input.ManagerId=ManagerId
  input.role in ["OmcSystemAdministrator","OmcEquipmentAdministrator","OmcSystemObserver","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET","DELETE"]
  input.path = ["redfish","v1","Managers",ManagerId,"Oem","Ericsson_2","TrustedCertificates",TrustedCertificateId]
  input.ManagerId=ManagerId
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","Bridges"]
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","Bridges",bridgeId]
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","Bridges",bridgeId,"BridgePorts"]
  input.bridgeId = bridgeId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","Bridges",bridgeId,"BridgePorts",bridgePortId]
  input.bridgeId = bridgeId
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","Bridges",bridgeId,"BridgePorts",bridgePortId,"VLANs"]
  input.bridgeId = bridgeId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","Bridges",bridgeId,"BridgePorts",bridgePortId,"VLANs",vlanId]
  input.vlanId = vlanId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","DataBridges"]
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","DataBridges",dataBridgeId]
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","DataBridges",dataBridgeId,"BridgePorts"]
  input.dataBridgeId=dataBridgeId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","DataBridges",dataBridgeId,"BridgePorts",bridgePortId]
  input.dataBridgeId=dataBridgeId
  input.bridgePortId=bridgePortId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","DataBridges",dataBridgeId,"VLANs"]
  input.dataBridgeId=dataBridgeId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","DataBridges",dataBridgeId,"VLANs",vlanId]
  input.dataBridgeId=dataBridgeId
  input.vlanId=vlanId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","Racks"]
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","Racks",rackId]
  input.rackId=rackId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","RedfishAssets"]
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","RedfishAssets",RedfishAssetId]
...
allow {    
  input.method in ["POST"]
  input.path = ["redfish","v1","Oem","Ericsson_2","RedfishAssets",RedfishAssetId,"Actions","Ericsson2RedfishAsset.RemoveCredential"]
  input.RedfishAssetId=RedfishAssetId
  input.role in ["OmcSecurityAdministrator"]
}
...
allow {    
  input.method in ["POST"]
  input.path = ["redfish","v1","Oem","Ericsson_2","RedfishAssets",RedfishAssetId,"Actions","Ericsson2RedfishAsset.SetCredential"]
  input.RedfishAssetId=RedfishAssetId
  input.role in ["OmcSecurityAdministrator"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","SDIPods"]
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","SDIPods",SDIPodId]
...
allow {    
  input.method in ["POST"]
  input.path = ["redfish","v1","Oem","Ericsson_2","SDIPods",SDIPodId,"Actions","Ericsson2SDIPod.ModifyPmJob"]
  input.SDIPodId=SDIPodId
  input.role in ["OmcEquipmentAdministrator"]
}
...
allow {    
  input.method in ["POST"]
  input.path = ["redfish","v1","Oem","Ericsson_2","SDIPods",SDIPodId,"Alarms"]
  input.SDIPodId=SDIPodId
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","SDIPods",SDIPodId,"Bridges"]
  input.SDIPodId=SDIPodId
  input.role in ["OmcEquipmentAdministrator","OmcSecurityAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","SDIPods",SDIPodId,"DataBridges"]
  input.SDIPodId=SDIPodId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","SDIPods",SDIPodId,"PmJobConfiguration"]
  input.SDIPodId=SDIPodId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","SDIPods",SDIPodId,"Racks"]
  input.SDIPodId=SDIPodId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","SDIPods",SDIPodId,"RedfishAssets"]
  input.SDIPodId=SDIPodId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","SDIPods",SDIPodId,"Switches"]
  input.SDIPodId=SDIPodId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","SDIPods",SDIPodId,"Systems"]
  input.SDIPodId=SDIPodId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","SDIPods",SDIPodId,"TopologyLinks"]
  input.SDIPodId=SDIPodId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET","POST"]
  input.path = ["redfish","v1","Oem","Ericsson_2","SDIPods",SDIPodId,"VPODs"]
  input.SDIPodId=SDIPodId
  input.role in ["OmcEquipmentAdministrator"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","Switches"]
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","Switches",switchId]
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","Switches",switchId,"ExternalLinks"]
  input.switchId=switchId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","Switches",switchId,"ExternalLinks",externalLinkId]
  input.switchId=switchId
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","Switches",switchId,"Pims"]
  input.switchId=switchId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","Switches",switchId,"Pims",pimId]
  input.pimId=pimId
  input.switchId=switchId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","TopologyLinks"]
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","VPODs"]
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  ...
  input.path = ["redfish","v1","Oem","Ericsson_2","VPODs",vPODId]
  input.vPODId=vPODId
  input.role in ["OmcEquipmentAdministrator"]
}
...
allow {    
  input.method in ["POST"]
  input.path = ["redfish","v1","Oem","Ericsson_2","VPODs",vPODId,"Actions","Ericsson2VPOD.Allocate"]
  input.vPODId=vPODId
  input.role in ["OmcEquipmentAdministrator"]
}
...
allow {    
  input.method in ["POST"]
  input.path = ["redfish","v1","Oem","Ericsson_2","VPODs",vPODId,"Actions","Ericsson2VPOD.ConnectManualSelectedPorts"]
  input.vPODId=vPODId
  input.role in ["OmcEquipmentAdministrator"]
}
...
allow {    
  input.method in ["POST"]
  input.path = ["redfish","v1","Oem","Ericsson_2","VPODs",vPODId,"Actions","Ericsson2VPOD.CreateL2Network"]
  input.vPODId=vPODId
  input.role in ["OmcEquipmentAdministrator"]
}
...
allow {    
  input.method in ["POST"]
  input.path = ["redfish","v1","Oem","Ericsson_2","VPODs",vPODId,"Actions","Ericsson2VPOD.CreateL2NetworkWithAutomaticConnectivityForAllPorts"]
  input.vPODId=vPODId
  input.role in ["OmcEquipmentAdministrator"]
}
...
allow {    
  input.method in ["POST"]
  input.path = ["redfish","v1","Oem","Ericsson_2","VPODs",vPODId,"Actions","Ericsson2VPOD.CreateL2NetworkWithAutomaticConnectivityForSelectedPorts"]
  input.vPODId=vPODId
  input.role in ["OmcEquipmentAdministrator"]
}
...
allow {    
  input.method in ["POST"]
  input.path = ["redfish","v1","Oem","Ericsson_2","VPODs",vPODId,"Actions","Ericsson2VPOD.Deallocate"]
  input.vPODId=vPODId
  input.role in ["OmcEquipmentAdministrator"]
}
...
allow {    
  input.method in ["POST"]
  input.path = ["redfish","v1","Oem","Ericsson_2","VPODs",vPODId,"Actions","Ericsson2VPOD.DisconnectManualSelectedPorts"]
  input.vPODId=vPODId
  input.role in ["OmcEquipmentAdministrator"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","VPODs",vPODId,"Networks"]
  input.vPODId=vPODId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","VPODs",vPODId,"Networks",VLANId]
  input.VLANId=VLANId
  input.vPODId=vPODId
  input.role in ["OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","VPODs",vPODId,"Systems"]
  input.vPODId=vPODId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Oem","Ericsson_2","VPODs",vPODId,"Systems",ComputerSystemId]
  input.vPODId=vPODId
...
allow {    
  input.method in ["GET","PATCH"]
  input.path = ["redfish","v1","Systems",ComputerSystemId]
  input.ComputerSystemId=ComputerSystemId
  input.role in ["OmcEquipmentAdministrator"]
}
...
allow {    
  input.method in ["POST"]
  input.path = ["redfish","v1","Systems",ComputerSystemId,"Actions","ComputerSystem.Reset"]
  input.ComputerSystemId=ComputerSystemId
  input.role in ["OmcEquipmentAdministrator"]
}
...
allow {    
  input.method in ["POST"]
  input.path = ["redfish","v1","Systems",ComputerSystemId,"Actions","Oem","Ericsson2ComputerSystem.BootSourceOverride"]
  input.ComputerSystemId=ComputerSystemId
  input.role in ["OmcEquipmentAdministrator"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Systems",ComputerSystemId,"EthernetInterfaces"]
  input.ComputerSystemId=ComputerSystemId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Systems",ComputerSystemId,"EthernetInterfaces",EthernetInterfaceId]
  input.ComputerSystemId=ComputerSystemId
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Systems",ComputerSystemId,"Memory"]
  input.ComputerSystemId=ComputerSystemId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Systems",ComputerSystemId,"Memory",MemoryId]
  input.ComputerSystemId=ComputerSystemId
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Systems",ComputerSystemId,"Oem","Ericsson_2","FwComponents"]
  input.ComputerSystemId=ComputerSystemId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Systems",ComputerSystemId,"Oem","Ericsson_2","FwComponents",FwComponentId]
  input.ComputerSystemId=ComputerSystemId
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Systems",ComputerSystemId,"Processors"]
  input.ComputerSystemId=ComputerSystemId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Systems",ComputerSystemId,"Processors",ProcessorId]
  input.ComputerSystemId=ComputerSystemId
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Systems",ComputerSystemId,"ResetActionInfo"]
  input.ComputerSystemId=ComputerSystemId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Systems",ComputerSystemId,"SimpleStorage"]
  input.ComputerSystemId=ComputerSystemId
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","Systems",ComputerSystemId,"SimpleStorage",SimpleStorageId]
  input.ComputerSystemId=ComputerSystemId
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","UpdateService"]
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET"]
  input.path = ["redfish","v1","UpdateService","Oem","Ericsson_2","Packages"]
  input.role in ["OmcEquipmentAdministrator","OmcEquipmentObserver"]
}
...
allow {    
  input.method in ["GET","DELETE"]
  input.path = ["redfish","v1","UpdateService","Oem","Ericsson_2","Packages",PackageId]
...
allow {    
  input.method in ["POST"]
  input.path = ["files","upload","updateservice","package"]
  input.role in ["OmcEquipmentAdministrator"]
}
